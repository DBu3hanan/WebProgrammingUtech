...
function register() {
    ...
    EduLevel1 = document.getElementById("edulevel1").value;
...
window.onload = function () {
    ...
    function showAll() {
        ...
        const PlayersData = [Fname, Lname, Email, DOfB, Street, City, Town, Country, Images, EduLevel, Gender];
        PlayersData.push("Age:" + age, + "Correct: " + getright, "Incorrect:" + getwrong, "Answered: " + answered, "Percetage: " + percentage + "%", "Final Total:" + playerstotal);

        for (var i = 0; i < PlayersData.length; i++) {
            console.log(PlayersData[i].value)
        }

        const string = JSON.stringify(PlayersData, null, 4);
        document.getElementById("showallplayers").innerHTML = string;
    ...
    C5Q4.onclick = function () {
        restart();
        checkAnswer();

        function unhides() {
            document.getElementById('5Q4').hidden = true; //hides question button
            document.getElementById('langq').hidden = false;  //hides the questions and answers are covered
            document.getElementById('lang1').hidden = false;
            document.getElementById('lang2').hidden = false;
        ...
        function hide() {
            document.getElementById('langq').hidden = true;
            document.getElementById('lang1').hidden = true;
            document.getElementById('lang2').hidden = true;
            document.getElementById('answer').hidden = true;
        ...
        function disabledb() {
            ...
            document.getElementById('lang1').disabled = true;
            document.getElementById('lang2').disabled = true;
    ...
    C5Q5.onclick = function () {
        restart();
        checkAnswer();

        function unhides() {
            document.getElementById('5Q5').hidden = true; //hides question button
            document.getElementById('diceq').hidden = false;  //hides the questions and answers are covered
            document.getElementById('dice1').hidden = false;
            document.getElementById('dice2').hidden = false;
            document.getElementById('dice3').hidden = false;
        ...
        function hide() {
            document.getElementById('diceq').hidden = true;
...
} // Do not put anything beyond this curly brace